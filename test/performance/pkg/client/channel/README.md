#Benchmark testing of Channel Client
	...
	(
	    ...
	    * the command output also shows the environment and the package used for the benchmark exection:
	        goos: darwin
            goarch: amd64
            pkg: ki-sdk/test/performance/pkg/client/channel
...
##### - Benchmark command examples:
    ...
    PASS
    ok  	ki-sdk/test/performance/pkg/client/channel	6.618s
    ...
    PASS
    ok  	ki-sdk/test/performance/pkg/client/channel	68.788s
    ...
    PASS
    ok  	ki-sdk/test/performance/pkg/client/channel	213.246s
    ...
    PASS
    ok  	ki-sdk/test/performance/pkg/client/channel	433.668s
    ...
    PASS
    ok  	ki-sdk/test/performance/pkg/client/channel	926.270s
